...
export class SocketRepository {
    static async saveMessage(params: IMessageSend, userId: number): Promise<IMessage> {
        ...
        const result = await pgPoolQuery(sql, [params.room, params.message, userId, params.interlocutorId]);
    ...
    static async saveFilePath(params: IFileMessage): Promise<IMessage> {
        ...
        const result = await pgPoolQuery(sql, [params.userId, params.interlocutorId, params.room, params.filePath]);
